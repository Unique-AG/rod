...
## [Documentation](https://go-rod.github.io/) | [API reference](https://pkg.go.dev/github.com/Unique-AG/rod?tab=doc) | [Management](https://github.com/orgs/go-rod/projects/1)
...
- Lightweight, no third-party dependencies, [CI](https://github.com/Unique-AG/rod/actions) tested on Linux, Mac, and Windows
